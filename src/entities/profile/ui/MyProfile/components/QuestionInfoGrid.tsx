    ...
    <div className={styles.Grid}>
      <div className={styles.GridRow}>
        <div className={styles.Cell}>
          <ProfileCellHeader title={'반려동물'} onClickEdit={() => onClickEdit?.('name')} />
      ...
      <div className={styles.GridRow}>
        <div className={styles.Cell}>
          <ProfileCellHeader title={'음식'} onClickEdit={() => onClickEdit?.('name')} />
          <div className={styles.ChipList}>
      ...
      <div className={styles.GridRow}>
        <div className={styles.Cell}>
          <ProfileCellHeader title={'데이트 스타일'} onClickEdit={() => onClickEdit?.('name')} />
          <div className={styles.ChipList}>
      ...
      <div className={styles.GridRow}>
        <div className={styles.Cell}>
          <ProfileCellHeader title={'인생책'} onClickEdit={() => onClickEdit?.('name')} />
          <b>{profile.book.bookName}</b> <span>{profile.book.cause}</span>
        </div>
      </div>
      <div className={styles.GridRow}>
        <div className={styles.Cell}>
          <ProfileCellHeader title={'인생영화'} onClickEdit={() => onClickEdit?.('name')} />
