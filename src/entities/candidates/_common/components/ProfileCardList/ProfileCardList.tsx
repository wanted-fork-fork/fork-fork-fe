...
type Props<InfoType extends ProfileSummary> = {
  ...
  footerSlot?: (profile: InfoType) => ReactElement;
};

export const ProfileCardList = <InfoType extends ProfileSummary>({ profileList, profileActionSlot, getLink, footerSlot }: Props<InfoType>) => {
  return (
