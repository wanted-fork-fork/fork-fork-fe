import styles from 'src/entities/candidates/components/GenerateFormLink/GenerateFormLink.module.css';
...
const GenerateFormLinkBottomSheet = lazy(async () => {
  const module = await import('src/entities/candidates/components/GenerateFormLink/GenerateFormLinkBottomSheet');
