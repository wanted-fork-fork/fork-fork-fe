...
export type UpdateInfoStatusStatus = typeof UpdateInfoStatusStatus[keyof typeof UpdateInfoStatusStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateInfoStatusStatus = {
  IN_RELATIONSHIP: 'IN_RELATIONSHIP',
} as const;

export type UpdateInfoStatusParams = {
infoId: string;
status?: UpdateInfoStatusStatus;
};
...
export type GroupInfoWithDetailResponseStatus = typeof GroupInfoWithDetailResponseStatus[keyof typeof GroupInfoWithDetailResponseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GroupInfoWithDetailResponseStatus = {
  IN_RELATIONSHIP: 'IN_RELATIONSHIP',
} as const;
...
export interface GroupInfoWithDetailResponse {
  ...
  status?: GroupInfoWithDetailResponseStatus;
}

export type SearchGroupInfoRequestDtoUserStatus = typeof SearchGroupInfoRequestDtoUserStatus[keyof typeof SearchGroupInfoRequestDtoUserStatus];
...
export interface SearchGroupInfoRequestDto {
  ...
  userStatus?: SearchGroupInfoRequestDtoUserStatus;
}
...
export type ArchivedInfoResponseStatus = typeof ArchivedInfoResponseStatus[keyof typeof ArchivedInfoResponseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ArchivedInfoResponseStatus = {
  IN_RELATIONSHIP: 'IN_RELATIONSHIP',
} as const;
...
export interface ArchivedInfoResponse {
  ...
  religion: Religion;
  smoking: UserInfoSmoking;
  status?: ArchivedInfoResponseStatus;
}

export type SearchInfoRequestDtoUserStatus = typeof SearchInfoRequestDtoUserStatus[keyof typeof SearchInfoRequestDtoUserStatus];
...
export interface SearchInfoRequestDto {
  ...
  userStatus?: SearchInfoRequestDtoUserStatus;
}
...
export type UserInfoRequestStatus = typeof UserInfoRequestStatus[keyof typeof UserInfoRequestStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UserInfoRequestStatus = {
  IN_RELATIONSHIP: 'IN_RELATIONSHIP',
} as const;
...
export type DetailedInfoUserInfoStatus = typeof DetailedInfoUserInfoStatus[keyof typeof DetailedInfoUserInfoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DetailedInfoUserInfoStatus = {
  IN_RELATIONSHIP: 'IN_RELATIONSHIP',
} as const;
...
export interface DetailedInfoUserInfo {
  ...
  religion: Religion;
  smoking: UserInfoSmoking;
  status?: DetailedInfoUserInfoStatus;
}
...
export const updateInfoStatus = (
    params: UpdateInfoStatusParams,
 options?: SecondParameter<typeof customInstance>,) => {
      return customInstance<string>(
      {url: `/api/v1/info/status`, method: 'PUT',
        params
    },
      options);
    }
...
export type RootResult = NonNullable<Awaited<ReturnType<typeof root>>>
export type Root1Result = NonNullable<Awaited<ReturnType<typeof root1>>>
...
export type UpdateInfoStatusResult = NonNullable<Awaited<ReturnType<typeof updateInfoStatus>>>
...
export const getRoot1ResponseMock = (): string => (faker.word.sample())
...
export const getUpdateInfoStatusResponseMock = (): string => (faker.word.sample())
...
export const getGetGroupMembersResponseMock = (): GroupMemberResponse[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({status: faker.helpers.arrayElement(['ADMIN','MEMBER','PENDING'] as const), userId: faker.word.sample(), userName: faker.word.sample(), userProfileImage: faker.helpers.arrayElement([faker.word.sample(), undefined])})))
...
export const getRootMockHandler = (overrideResponse?: string | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<string> | string)) => {
...
export const getRoot1MockHandler = (overrideResponse?: string | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<string> | string)) => {
  return http.post('*/', async (info) => {await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined 
            ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse) 
            : getRoot1ResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
...
export const getUpdateInfoStatusMockHandler = (overrideResponse?: string | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => Promise<string> | string)) => {
  return http.put('*/api/v1/info/status', async (info) => {await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined 
            ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse) 
            : getUpdateInfoStatusResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
...
export const getGoogooApiMock = () => [
  ...
  getUpdateInfoStatusMockHandler(),
