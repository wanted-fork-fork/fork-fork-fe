import styles from 'src/domains/candidates/components/LocationSelectTable/LocationSelectTable.module.css';
...
import { locationListMock } from 'src/domains/candidates/vo/location/mocks/location.mock';
